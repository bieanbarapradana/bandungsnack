                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="block">
                                ...
                                <form id="form-validation" action="<?=base_url('Seller/update/'.$data_sellers->id_seller)?>" method="post" class="form-horizontal form-bordered">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="seller_name" name="seller_name" value="<?=$data_sellers->seller_name?>" class="form-control" placeholder="Seller Name">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <textarea id="address" name="address" rows="6" class="form-control" placeholder="Seller Address"><?=$data_sellers->address?> </textarea>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="contact" value="<?=$data_sellers->contact?>"  name="contact" class="form-control" placeholder="Contact">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="email" id="email" name="email" class="form-control" placeholder="Email" value="<?=$data_sellers->email?>">
                                    ...
                                    <div class="form-group form-actions">
                                        ...
                                        <div class="col-md-8 col-md-offset-3">
                                            ...
                                            <button type="reset" class="btn btn-sm btn-warning"><i class="fa fa-times"></i> Back</button>
