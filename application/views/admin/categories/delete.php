                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="block">
                                ...
                                <form id="form-validation" action="<?=base_url('Categories/proses_delete/'.$id_category)?>" method="post" class="form-horizontal form-bordered">
                                    <fieldset>
                                 ...
                                 <a href="<?=base_url('Seller')?>" class="btn btn-sm btn-warning"><i class="fa fa-times"></i> Cencel</a>
                                        </div>
                                    </div>
