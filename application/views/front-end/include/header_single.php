             ...
             <li class="hidden-xs"> <a href=""> <i class="fa fa-files-o"></i> <span> Halaman </span> <i class="fa fa-angle-right"></i> </a>
              ...
              <div class="dropdown-menu flyout-menu"> 
                ...
                <ul>
				  ...
				  <li> <a href="<?=base_url('Produk_Kue_Basah')?>">Kue Basah </a></li>
...
<div class="slider">
          ...
          <div id="iview"> 
            ...
            <div data-iview:image="<?=base_url('assets/front-end/images/slide/maga-sale-1.png');?>" data-iview:pausetime="80">
            ...
            <div data-iview:image="<?=base_url('assets/front-end/images/slide/maga-sale.png');?>"data-iview:pausetime="80">
            ...
            <div data-iview:image="<?=base_url('assets/front-end/images/slide/cc1.png');?>"data-iview:pausetime="80">
