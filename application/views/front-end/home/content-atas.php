                  ...
                  <div class="product-block">
                    ...
                    <div class="product-meta">
                      ...
                      <div class="big-btns"> <a class="btn btn-default btn-view pull-left" href="<?=base_url('Jajan/detail/'.$value->id_product)?>">View</a> 
                          ...
                          if ($value->stock==0) {
                            ?>
                      <button value="<?php echo $value->id_product; ?>" class="btn btn-default btn-addtocart pull-right  stock_abis" >Add to Cart</button>       <?php
                          }
                          elseif ($value->stock<0) {
                           ?>
                     <button value="<?php echo $value->id_product; ?>" class="btn btn-default btn-addtocart pull-right  stock_abis" >Add to Cart</button>       <?php 
                ...
                <div class="product-meta">
                  ...
                  <a class="btn btn-default btn-view pull-left" href="<?=base_url('Jajan/detail/'.$promo_spesial_1->id_product)?>">View</a>
                     ...
                     <?php
                      ...
                      <button value="<?php echo $promo_spesial_1->id_product; ?>" class="btn btn-default btn-addtocart pull-right  stock_abis" >Add to Cart</button>          <?php
                          }
                  ...
                  <div class="big-btns"> <a class="btn btn-default btn-view pull-left" href="<?=base_url('Jajan/detail/'.$new_product->id_product)?>">View</a> 
                     ...
                     <?php
                          if ($new_product->stock==0) {
                            ?>
                       <button value="<?php echo $new_product->id_product; ?>" class="btn btn-default btn-addtocart pull-right  stock_abis" >Add to Cart</button>         <?php
                          }
                       ...
                       <button value="<?php echo $new_product->id_product; ?>" class="btn btn-default btn-addtocart pull-right  stock_abis" >Add to Cart</button>         <?php
                            ...
                            ?>
                      <button value="<?php echo $new_product->id_product; ?>" class="btn btn-default btn-addtocart pull-right  addlabtype" >Add to Cart</button>         <?php
                          }
                      ?>
                    </div>
                  ...
                  <div class="big-btns"> <a class="btn btn-default btn-view pull-left" href="<?=base_url('Jajan/detail/'.$promo_spesial_2->id_product)?>">View</a>
                     ...
                     <?php
                          if ($promo_spesial_2->stock==0) {
                            ?>
                       <button value="<?php echo $promo_spesial_2->id_product; ?>" class="btn btn-default btn-addtocart pull-right  stock_abis" >Add to Cart</button>          <?php
                          }
