  ...
  <div class="row">
    <div class="col-md-12">
      <div class="page-title">
        <h2>Syarat dan Ketentuan Garansi</h2>
      </div>
    </div>
  </div>
</div>
...
<div class="container">
          ...
          <p>Kami akan sangat menjamin kualitas produk yang kami jual kepada konsumen dan kami dan kami
		  akan menjamin penuh akan kelayakan produk kami, sehingga jika konsumen menerima produk yang tidak sesuai atau tidak layak maka segera hubungi
  ...
  <div class="row">
    <div class="col-md-3"> 
      ...
      <div class=" feature-box">
        ...
        <p> Kami memberikan kualitas <strong>dukungan</strong>,Kami sinergis menyusun strategi di seluruh dunia dengan seluruh fungsinya. </p>
      </div>
    </div>
    <!-- end: feature box --> 
    <!-- feature box -->
    <div class="col-md-3">
      <div class=" feature-box">
        ...
        <p> Berbagai <strong>ulasan produk</strong>,  semua produk yang kami berikan telah terjamin higienis dan telah tersertifikasi halal . </p>
      </div>
    </div>
    <!-- end: feature box --> 
    <!-- feature box -->
    ...
    <div class="col-md-3">
      <div class=" feature-box">
        ...
        <p> Kami menjamin pengiriman<em>produk yang dibeli</em>dapat segera dikemas dan dilanjutkan pada proses pengiriman</p>
      </div>
    </div>
  </div>
</div>
