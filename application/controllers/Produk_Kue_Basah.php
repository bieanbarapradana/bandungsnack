...
class Produk_Kue_Basah extends CI_Controller {
...

	{
		...
		$this->data['terlaris_aktif'] = $this->Products_model->_jajan_terlaris_kue_basah()->result(); 



		$this->data['terlaris_non_aktif'] = $this->Products_model->_jajan_terlaris_1_kue_basah()->result(); 
	...
	//	var_dump($aa);
...

		{
			...
			$a =$this->data['data_product_atas'] = $this->Products_model->__product_atas_kue_basah(0,4)->result(); 

		//	var_dump($a);

			$this->data['data_product_atas_next'] = $this->Products_model->__product_atas_next_kue_basah(4,4)->result(); 
...

		{
			...
			$this->data['data_product_atas'] = $this->Products_model->__product_atas_kue_basah(0,3)->result(); 

			

			$this->data['data_product_atas_next'] = $this->Products_model->__product_atas_next_kue_basah(3,3)->result(); 
		...
		$tampilan_view[] = 'front-end/kue/content-atas';



		$tampilan_view[] = 'front-end/kue/content-terlaris';
