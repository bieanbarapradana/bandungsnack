...
class Notif_customers extends CI_Controller {
	...
	function cek_notif()
	{
		$data=$this->Notifikasi_customers_model->get_notif();
		echo "(".count($data).")";
		
	}
	function cek_notif_order()
	{
		$data=$this->Orders_model->get_new_order_for_customer()->result();
		echo "(".count($data).")";
