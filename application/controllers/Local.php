...
class Local extends CI_Controller {
...

	{
		...
		$this->data['terlaris_aktif'] = $this->Products_model->_jajan_terlaris_local()->result(); 

		$this->data['terlaris_non_aktif'] = $this->Products_model->_jajan_terlaris_1_local()->result(); 
	...
	//	var_dump($aa);
		...
		if ($aa==null) 
		{
			$a =$this->data['data_product_atas'] = $this->Products_model->__product_atas_local(0,4)->result(); 
		//	var_dump($a);
			$this->data['data_product_atas_next'] = $this->Products_model->__product_atas_next_local(4,4)->result(); 
		}
		else
		{
			$this->data['data_product_atas'] = $this->Products_model->__product_atas_local(0,3)->result(); 
			
			$this->data['data_product_atas_next'] = $this->Products_model->__product_atas_next_local(3,3)->result(); 
		}
		...
		$tampilan_view[] = 'front-end/local/content-atas';

		$tampilan_view[] = 'front-end/local/content-terlaris';
